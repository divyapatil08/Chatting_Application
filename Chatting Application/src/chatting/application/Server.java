...
//        
//        text= new JTextField();
//        text.setBounds(5,585,310,40);
//        text.setFont(new Font("SAN_SERIF", Font.PLAIN,16));
//        f.add(text);
//        
//        JButton send = new JButton("Send");
//        send.setBounds(320, 585, 123,40);
...
//        f.setSize(450, 700);
//        f.setLocation(0, 0);
//       //setUndecorated(true); //frame haeder
...
public class Server implements ActionListener {
    ...
    public static void main(String args[]) {
        new Server();
         ...
         try {
            ServerSocket skt = new ServerSocket(6003); // Change the port to 6003
            while (true) {
                Socket s = skt.accept();
                DataInputStream din = new DataInputStream(s.getInputStream());
                // dout = new DataOutputStream(s.getOutputStream()); // Remove this line
